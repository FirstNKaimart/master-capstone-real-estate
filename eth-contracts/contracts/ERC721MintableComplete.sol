...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require( ownerOf(tokenId) != to , "Given address must not be the owner of the token");
...
contract ERC721MintableComplete is ERC721Metadata {
    ...
    constructor() public
        ERC721Metadata("Real Estate", "REAL", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
